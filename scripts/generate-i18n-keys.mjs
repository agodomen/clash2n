...
const LOCALE_DIR = path.resolve(ROOT_DIR, 'front/locales/en')
const KEY_OUTPUT = path.resolve(ROOT_DIR, 'front/types/generated/i18n-keys.ts')
const RESOURCE_OUTPUT = path.resolve(
  ROOT_DIR,
  'front/types/generated/i18n-resources.ts',
)
